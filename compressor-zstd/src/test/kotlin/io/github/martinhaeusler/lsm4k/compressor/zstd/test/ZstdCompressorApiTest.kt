package io.github.martinhaeusler.lsm4k.compressor.zstd.test
...
import io.github.martinhaeusler.lsm4k.compressor.zstd.ZstdCompressor
...
class ZstdCompressorApiTest {

    @Test
    fun canCreateInstanceViaServiceLoader() {
        expectThat(getCompressor()).isA<ZstdCompressor>()
    }
    ...
    private fun getCompressor(): Compressor {
        return Compressors.getCompressorForName(ZstdCompressor.UNIQUE_NAME)
    }
