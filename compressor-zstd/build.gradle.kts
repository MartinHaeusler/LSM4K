...
publishing {
    ...
    publications {
        create<MavenPublication>("lsm4k-zstd-compressor") {
            ...
            pom {
                name.set("LSM4K ZSTD Compressor")
                description.set("A ZSTD-based Compressor implementation for LSM4K.")
...
signing {
    ...
    sign(publishing.publications["lsm4k-zstd-compressor"])
}
