...
import org.lsm4k.api.exceptions.LSM4KException
import org.lsm4k.io.vfs.VirtualReadWriteFile
import org.lsm4k.io.vfs.disk.DiskBasedVirtualReadWriteFile
import org.lsm4k.util.ExceptionUtils
...
class LockFileManager(
    ...
    private fun throwFailedToLock(e: Exception? = null): Nothing {
        throw LSM4KException(
            "Failed to acquire lock on directory '${this.lockFile.path}'." +
                " LSM4K requires exclusive access to its directory." +
                " Is there another instance of LSM4K still running?",
            e
        )
    }
}