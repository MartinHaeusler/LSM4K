...
import io.github.martinhaeusler.lsm4k.api.statistics.CursorStatisticsReport.Companion.sum
import io.github.martinhaeusler.lsm4k.api.statistics.TransactionStatisticsReport.Companion.sum
import io.github.martinhaeusler.lsm4k.io.format.cursor.LSMFileCursor
import io.github.martinhaeusler.lsm4k.util.Timestamp
import io.github.martinhaeusler.lsm4k.util.cursor.OverlayCursor
import io.github.martinhaeusler.lsm4k.util.cursor.VersioningCursor
import io.github.martinhaeusler.lsm4k.util.unit.BinarySize.Companion.Bytes
import java.util.*
import kotlin.time.Duration.Companion.milliseconds

/**
 * Immutable snapshot of the statistics of a [DatabaseEngine].
 */
data class StatisticsReport(
    ...
    val fileCursorStatistics: CursorStatisticsReport
        get() = this.getCursorStatistics(LSMFileCursor.CURSOR_NAME)
